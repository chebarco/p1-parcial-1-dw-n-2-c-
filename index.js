    ...
    for (let disco of discos) {
      ...
      for (let pista of disco.getPistas) {
        ...
        if (pista.getDuracion > 180) {
          innerHTML += ` <h2 class="titulo-nombre">Duracion:<p class="info-disco red"> ${pista.getDuracion}seg</p></h2>   </div>
`;
        } else {
          innerHTML += ` <h2 class="titulo-nombre">Duracion:<p class="info-disco"> ${pista.getDuracion}seg</p></h2>   </div>
`;
        }
      }
    }
